...
export default function Profile() {
    ...
    const defaultProfile = {
        name: user?.name || "Vedika Mamidwar",
        role: "MERN Developer",
        email: user?.email || "vedika@example.com",
        ...
        bio: "Passionate Computer Science student and MERN Developer interested in building innovative products, participating in hackathons and collaborating with talented developers.",
    ...
    const [profile, setProfile] = useState(() => {
        try {
            const saved = localStorage.getItem("conexaProfile");
                        ...
                        <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-7">
                            ...
                            <div className="mt-5 grid gap-3 sm:grid-cols-2">
                                ...
                                <InfoItem
                                    ...
                                    label="Education"
                                    value={`${profile.branch} • ${profile.year}`}
                                />
