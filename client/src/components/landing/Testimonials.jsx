        ...
        <section className="relative py-16 sm:py-20 lg:py-28 bg-white overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                ...
                <motion.div
                    ...
                    className="mt-10 sm:mt-14 rounded-3xl bg-gradient-to-r from-[#1E1B4B] via-[#312E81] to-[#1E1B4B] px-5 py-6 sm:px-8 sm:py-7 text-white shadow-xl relative overflow-hidden"
                >

                    <div className="absolute -top-20 -right-20 w-48 h-48 bg-[#14B8A6]/20 rounded-full blur-3xl" />
                    ...
                    <div className="relative flex flex-col sm:flex-row items-center justify-between gap-5 text-center sm:text-left">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-sm text-white/65">
                                    Find your team. Build something amazing.
                                </p>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className="w-full sm:w-auto px-6 py-3 rounded-xl bg-white text-[#1E1B4B] font-bold hover:bg-slate-100 active:scale-95 transition whitespace-nowrap"
                        >
                            Join CONEXA
                        </button>
